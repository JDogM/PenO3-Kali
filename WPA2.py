...
key = str(0x2b) + str(0x28) + str(0xab) + str(0x09) + str(0x7e) + str(0xae) + str(0xf7) + str(0xcf) + str(0x15) + str(0xd2) + str(0x15) + str(0x4f) + str(0x16) + str(0xa6) + str(0x88) + str(0x3c) #[[0x2b, 0x28, 0xab, 0x09], [0x7e, 0xae, 0xf7, 0xcf], [0x15, 0xd2, 0x15, 0x4f], [0x16, 0xa6, 0x88, 0x3c]]
